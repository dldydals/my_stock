...
import { Tag, Typography, Progress, Popover, Space, Tooltip } from "antd"; // 👈 Tooltip 추가
                                ...
                                <div className="mb-4 grid grid-cols-2 gap-3">
                                    ...
                                    <div className="bg-black/20 rounded-xl p-2.5 border border-white/5 flex flex-col justify-center gap-1">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <Text className="font-numeric" style={{ fontSize: 11, fontWeight: 700, color: (strat.foreign_buy || 0) > 0 ? "#fca5a5" : (strat.foreign_buy || 0) < 0 ? "#93c5fd" : "#cbd5e1" }}>
                                                {formatSupplyVolume(strat.foreign_buy)}
                                            </Text>
                                        </div>
                                        <div className="flex justify-between items-center">
                                            <Text style={{ fontSize: 10, color: "#94a3b8" }}>기관</Text>
                                            <Text className="font-numeric" style={{ fontSize: 11, fontWeight: 700, color: (strat.org_buy || 0) > 0 ? "#fca5a5" : (strat.org_buy || 0) < 0 ? "#93c5fd" : "#cbd5e1" }}>
                                                {formatSupplyVolume(strat.org_buy)}
                                            </Text>
                                        </div>
                                        <div className="flex justify-between items-center">
                                            <Text style={{ fontSize: 10, color: "#94a3b8" }}>개인</Text>
                                            <Text className="font-numeric" style={{ fontSize: 11, fontWeight: 700, color: (strat.individual_buy || 0) > 0 ? "#fca5a5" : (strat.individual_buy || 0) < 0 ? "#93c5fd" : "#cbd5e1" }}>
                                                {formatSupplyVolume(strat.individual_buy)}
                                            </Text>
                                        </div>
                                    </div>
